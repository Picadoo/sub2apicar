...
func (h *ConcurrencyHelper) withAPIKeySlotFromGin(c *gin.Context, releaseFunc func()) (func(), error) {
	...
	release, acquired, err := h.withAPIKeySlot(c.Request.Context(), apiKey.ID, apiKey.MaxConcurrency, releaseFunc)
	if err != nil {
		return nil, err
	}
	if !acquired {
...
func (h *ConcurrencyHelper) withAPIKeySlot(ctx context.Context, apiKeyID int64, maxConcurrency int, releaseFunc func()) (func(), bool, error) {
