export default {
  dashboard: {
    ...
    accountWindowQuota: {
      ...
      window7d: '7 天窗口',
      availableNow: '当前可用',
      availableSharedHint: '取个人额度与账号余量较小值',
      availableEstimateHint: '官方快照暂缺，按个人额度估算',
      officialUsed: '官方已用',
      accountCeiling: '安全线',
      siteAttributed: '已归因',
      personalLimit: '上限',
      baseShare: '基础 {pct}',
      unattributedNotice: '外部使用 {pct}，不计入成员',
      snapshotMissing: '官方快照暂缺',
      forceUnattributedNotice: '官方用量 {pct} 全部记为站外，不计入成员',
      forceUnattributedIdle: '官方用量全部记为站外，不计入成员',
      resetsAt: '{time} 重置',
      poolTitle: '救急池',
      poolRemaining: '可借 {pct}%',
      donateHint: '捐出 {donate}% · 自留 {keep}%',
      lockedDonationHint: '已被借用，至少保留 {pct}%',
      donateNote5h: '仅本窗口有效，刷新自动归零',
      donateNote7d: '长期有效，未借出部分随时可收回',
      borrowing: '救急池提额 +{pct}%',
      membersTitle: '同车成员',
    },
    chatProxy: {
