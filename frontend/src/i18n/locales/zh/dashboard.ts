export default {
  dashboard: {
    ...
    accountWindowQuota: {
      ...
      window7d: '7 天窗口',
      availableNow: '当前最多可用',
      availableSharedHint: '个人额度和账号安全余量取较小值；账号余量由所有成员及外部使用共享',
      availableEstimateHint: '官方快照暂缺，暂按个人额度估算',
      officialUsed: '账号官方已用',
      accountCeiling: '账号安全线',
      siteAttributed: '本站已归因',
      personalLimit: '个人当前上限',
      baseShare: '基础 {pct}',
      unattributedNotice: '其中 {pct} 来自外部或无法确认来源，不计入任何成员。',
      snapshotMissing: '官方快照暂缺，当前可用量仅按个人额度估算。',
      attributionSynced: '成员合计已归因 {pct}。',
      forceUnattributedNotice: '官方已用 {pct} 几乎全部来自站外渠道，按账号设置不计入任何成员。',
      forceUnattributedIdle: '本账号官方用量按设置全部记为站外来源，不计入任何成员。',
      attributed: '归因已用',
      baseLimit: '基础上限',
      effectiveLimit: '有效上限',
      remaining: '剩余',
      accountBreakdown: '账号官方 {official} · 已归因 {attributed} · 未归因 {unattributed}',
      resetsAt: '{time} 重置',
      poolTitle: '自愿救急池',
      poolRemaining: '可借 {pct}%',
      donateHint: '自愿捐出本窗口份额的 {donate}%，自留 {keep}%',
      lockedDonationHint: '其中已有额度被他人使用，本窗口至少需保留捐赠 {pct}%；重置后自动解锁。',
      ...
      membersTitle: '同车成员（本站归因 / 个人当前上限）',
    },
    chatProxy: {
      title: '网页版 ChatGPT 在线情况',
      idle: '当前无人使用',
      idleMin: '空闲{min}分钟',
      fullHint: '已满，其他人暂时连不上；等有人空闲（约 5 分钟无操作自动让位）即可。',
      note: '同时最多 {max} 人共用，降低封号风险',
    },
  ...
  usage: {
    ...
    apiKeyFilter: 'API 密钥',
    allApiKeys: '全部密钥',
    selectedKeyTodayTitle: '{name} 今日用量',
    selectedKeyTodayDescription: '按您的本地时区统计，仅展示当前所选 API 密钥。',
    todayRequests: '今日请求数',
    todayTokens: '今日 Token',
    todayActualCost: '今日实际消费',
    keyQuotaTitle: 'API 密钥额度使用率',
    keyQuotaTotal: '总额度',
    keyQuota5h: '5 小时额度',
    keyQuota1d: '每日额度',
    keyQuota7d: '7 天额度',
    keyQuotaResetsAt: '{time} 重置',
    noKeyQuotaConfigured: '此 API 密钥未设置总额度或窗口额度限制。',
    timeRange: '时间范围',
    exportCsv: '导出 CSV',
