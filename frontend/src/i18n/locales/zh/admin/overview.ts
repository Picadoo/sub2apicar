export default {
    ...
    users: {
      ...
      windowQuota: {
        ...
        hint: '已用% 来自官方利用率分摊，重置跟随官方窗口刷新。按账号按窗口设置 limit%。',
        account: '账号 #{id}',
        window5h: '5h',
        window7d: '7d（周）',
        columns: {
    ...
    windowQuotaOverview: {
      ...
      memberEditorHint: '勾选后即使用户从未使用过此账号，也会预建 5h / 7d 配额并参与均分；取消勾选会移出此拼车账号。',
      memberSearch: '搜索用户名、邮箱或用户 ID',
      saveMembers: '保存成员并均分',
      savingMembers: '保存中...',
      membersConfirm: '确认将账号 #{id} 的拼车成员设为当前选中的 {count} 人？额度将立即重新均分。',
      membersSaved: '拼车成员已保存并完成均分',
