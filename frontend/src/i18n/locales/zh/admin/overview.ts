export default {
    ...
    windowQuotaOverview: {
      ...
      memberEditorTitle: '显式指定成员',
      memberEditorHint: '保存后会同步成员列表；新增成员会创建 5h / 7d 配额记录，取消勾选会移出此拼车账号。需要统一额度时请另用“安全均分”。',
      memberSearch: '搜索用户名、邮箱或用户 ID',
      saveMembers: '保存成员',
      savingMembers: '保存中...',
      membersConfirm: '确认将账号 #{id} 的拼车成员更新为当前选中的 {count} 人？',
      membersSaved: '拼车成员已保存',
