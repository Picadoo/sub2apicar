export default {
  ...
  dashboard: {
    ...
    accountWindowQuota: {
      ...
      donateNote5h: '5h 临时让出：窗口每几小时就刷新，被借走的下个窗口自动回来，几乎无损。不捐则谁也动不了你的份额。',
      donateNote7d: '7d 是真捐周额度：随时拉回滑块就能收回还没被借走的部分；只有已经被借走的要等下周重置才回来。',
      borrowing: '🤝 救急池提额 +{pct}%',
  ...
  admin: {
    ...
    users: {
      ...
      windowQuota: {
        ...
        hint: '已用% 来自官方利用率分摊，重置跟随官方窗口刷新。按账号按窗口设置 limit%，所有用户之和不得超过该窗口总额上限。',
        account: '账号 #{id}',
        window5h: '5h',
        window7d: '7d（周）',
        columns: {
