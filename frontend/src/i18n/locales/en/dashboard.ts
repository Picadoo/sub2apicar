export default {
  dashboard: {
    ...
    accountWindowQuota: {
      ...
      subtitle: 'Official account headroom takes priority',
      account: 'Account #{id}',
      window5h: '5-hour window',
      window7d: '7-day window',
      availableNow: 'Maximum available now',
      availableSharedHint: 'Uses the lower of your personal allowance and account headroom. Account headroom is shared with members and external usage.',
      availableEstimateHint: 'Official snapshot unavailable. Estimated from your personal allowance.',
      officialUsed: 'Official account usage',
      accountCeiling: 'Account safety ceiling',
      siteAttributed: 'Attributed by this service',
      personalLimit: 'Current personal limit',
      baseShare: 'base {pct}',
      unattributedNotice: '{pct} came from external or unverified sources and is not charged to any member.',
      snapshotMissing: 'Official snapshot unavailable. Current availability is estimated from personal allowance only.',
      attributionSynced: 'Members have {pct} attributed in total.',
      forceUnattributedNotice: 'Official usage of {pct} comes almost entirely from off-site channels and, per account policy, is not charged to any member.',
      forceUnattributedIdle: 'All official usage on this account is recorded as off-site per account policy and is not charged to any member.',
      attributed: 'Attributed',
      baseLimit: 'Base limit',
      effectiveLimit: 'Effective limit',
      remaining: 'Remaining',
      accountBreakdown: 'Official {official} · attributed {attributed} · unattributed {unattributed}',
      resetsAt: 'Resets {time}',
      poolTitle: 'Voluntary Relief Pool',
      poolRemaining: '{pct}% available to borrow',
      donateHint: 'Donate {donate}% of this window and keep {keep}%',
      lockedDonationHint: 'Some donated quota is already in use. Keep at least {pct}% donated until this window resets.',
      donateNote5h: 'The 5h donation applies only to the current window and resets automatically when the official window refreshes.',
      donateNote7d: 'The 7d donation persists across window refreshes until you manually return it to 0; already borrowed quota returns after the weekly reset.',
      borrowing: 'Relief pool boost +{pct}%',
      acctRemaining: 'Account has {pct}% total usage remaining',
      membersTitle: 'Shared members (service attribution / current personal limit)',
    },
    chatProxy: {
      title: 'Shared ChatGPT Web Status',
      idle: 'No one is using it now',
      idleMin: 'Idle for {min} minutes',
      fullHint: 'All slots are occupied. Try again after someone becomes idle (about 5 minutes without activity).',
      note: 'Up to {max} concurrent users to reduce account risk',
    },
  ...
  usage: {
    ...
    selectedKeyTodayTitle: '{name} Today',
    selectedKeyTodayDescription: 'Calculated in your local timezone for the selected API key only.',
    todayRequests: 'Requests Today',
    todayTokens: 'Tokens Today',
    todayActualCost: 'Actual Cost Today',
    keyQuotaTitle: 'API Key Quota Usage',
    keyQuotaTotal: 'Total Quota',
    keyQuota5h: '5-Hour Quota',
    keyQuota1d: 'Daily Quota',
    keyQuota7d: '7-Day Quota',
    keyQuotaResetsAt: 'Resets {time}',
    noKeyQuotaConfigured: 'This API key has no total or window quota configured.',
    timeRange: 'Time Range',
