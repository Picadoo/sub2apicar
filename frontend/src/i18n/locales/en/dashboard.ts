export default {
  dashboard: {
    ...
    accountWindowQuota: {
      ...
      availableSharedHint: 'Lower of personal allowance and account headroom',
      availableEstimateHint: 'No official snapshot; estimated from personal allowance',
      officialUsed: 'Official used',
      accountCeiling: 'Ceiling',
      siteAttributed: 'Attributed',
      personalLimit: 'Limit',
      baseShare: 'base {pct}',
      unattributedNotice: 'External usage {pct}, not charged to members',
      snapshotMissing: 'No official snapshot',
      forceUnattributedNotice: 'Official usage {pct} recorded as off-site, not charged to members',
      forceUnattributedIdle: 'Official usage recorded as off-site, not charged to members',
      resetsAt: 'Resets {time}',
      poolTitle: 'Relief pool',
      poolRemaining: 'Borrowable {pct}%',
      donateHint: 'Donate {donate}% · keep {keep}%',
      lockedDonationHint: 'In use; keep at least {pct}%',
      donateNote5h: 'This window only; resets automatically',
      donateNote7d: 'Persists; reclaim unused share anytime',
      borrowing: 'Pool boost +{pct}%',
  ...
  keys: {
    ...
    maxConcurrencyHint: 'Maximum simultaneous requests for this key. 0 adds no key limit. User and account limits still apply; excess requests receive 429.',
    noGroup: 'No group',
