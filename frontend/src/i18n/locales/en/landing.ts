export default {
  ...
  keyUsage: {
    ...
    accountPoolDescription: 'Accounts and quota snapshots in this API key\'s group',
    accounts: 'accounts',
    ...
    updatedAt: 'Updated',
    noOfficialSnapshot: 'No official quota snapshot',
    yourSharedQuota: 'Your shared quota',
    limit: 'Limit',
    poolAvailable: 'Pool available',
    forceUnattributed: 'Official usage is not attributed to members',
    localAccountQuota: 'Local account quota',
    localQuotaHint: 'Account configuration (USD)',
    localTotal: 'Total',
    localDaily: 'Daily',
    localWeekly: 'Weekly',
    noAccounts: 'No accounts are available in this group',
