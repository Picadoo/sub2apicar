export default {
    ...
    windowQuotaOverview: {
      ...
      memberEditorTitle: 'Explicit shared members',
      memberEditorHint: 'Saving synchronizes the member list. New members receive 5h / 7d quota records; unselected users are removed. Use Safe Rebalance separately when you want uniform limits.',
      memberSearch: 'Search username, email, or user ID',
      saveMembers: 'Save members',
      savingMembers: 'Saving...',
      membersConfirm: 'Update account #{id} to the selected {count} shared members?',
      membersSaved: 'Shared members saved',
