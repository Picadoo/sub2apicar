export default {
    ...
    users: {
      ...
      windowQuota: {
        ...
        hint: 'Used % is attributed from official utilization and resets with the official window. Set the limit per account and window.',
        account: 'Account #{id}',
        window5h: '5h',
        window7d: '7d (weekly)',
        columns: {
    ...
    windowQuotaOverview: {
      ...
      memberEditorHint: 'Selected users receive 5h / 7d quota records and join the rebalance even if they have never used this account. Unselected users are removed.',
      memberSearch: 'Search username, email, or user ID',
      saveMembers: 'Save members and rebalance',
      savingMembers: 'Saving...',
      membersConfirm: 'Set account #{id} to the selected {count} members and rebalance their quotas now?',
      membersSaved: 'Members saved and quotas rebalanced',
