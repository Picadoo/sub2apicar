export default {
    ...
    users: {
      ...
      platformQuota: {
        ...
        usdSectionTitle: 'Platform USD spending limits',
        usdSectionDescription: 'These daily / weekly / monthly USD limits are independent from the official Codex 5h / 7d window quotas below.',
        columns: {
          platform: 'Platform',
          daily: 'Daily (USD)',
          weekly: 'Weekly (USD)',
        ...
        saving: 'Saving...',
        cancel: 'Cancel',
        clearAll: 'Set all to unlimited',
        clearAllConfirm: 'Set every platform daily / weekly / monthly limit to unlimited? This is a high-risk bulk change and removes all platform USD limits after saving.',
        disableConfirm: 'Disable the {window} quota for {platform}? After saving, this platform cannot be used in that window.',
        discardConfirm: 'There are unsaved quota changes. Discard them and close?',
        unsavedIndicator: 'Unsaved changes',
        states: {
          title: 'Three states:',
          explanation: 'Unlimited = null; disabled = 0; limited = a positive number. Values are submitted exactly as selected without converting between states.',
          unlimited: 'Unlimited',
          disabled: 'Disabled',
          limited: 'Limited',
        },
      ...
      windowQuota: {
        ...
        officialDescription: 'This controls each member’s share of official Codex window utilization, not USD spending. The 5h and 7d windows reset independently with the upstream service.',
        ...
        hint: 'Attributed % comes from official utilization and resets with the official window. Set the base limit per account and window.',
        account: 'Account #{id}',
        window5h: '5h',
        window7d: '7d (weekly)',
        official: 'Official',
        ...
        columns: {
          ...
          remaining: 'Remaining',
          officialAttribution: 'Official / unattributed',
          reset: 'Resets',
        },
        saveSuccess: 'Saved',
        saveFailed: 'Save failed',
        invalidLimit: 'Limit must be a number between 0 and 100',
        disableConfirm: 'Set account #{account} {window} quota to 0? This user will be unable to use that official window.',
        invalidCeiling: 'Ceiling must be a number between 1 and 100',
        globalConfigHint: 'Global seat count and window ceilings are configured on the admin dashboard; this section only sets the selected user’s limit. Empty/default values use ceiling ÷ seats.',
      }
    },

    windowQuotaConfig: {
      title: 'Carpool Quota Configuration (Codex)',
      subtitle: 'Default member count for future rows and window ceilings',
      seatsLabel: 'Default members for new records',
      perSeat: 'New-record default ≈ {pct}%',
      ceiling5h: '5h window total ceiling',
      ceiling7d: '7d window total ceiling',
      save: 'Save',
      saved: 'Saved',
      saveFailed: 'Save failed',
      invalidSeats: 'Seats must be an integer between 1 and 100',
      invalidCeiling: 'Ceiling must be a number between 1 and 100',
      note: '“Default members for new records” only applies when future quota rows are created. Saving it never rewrites existing member rows; use Safe Rebalance in the overview to adjust current members. Window ceilings take effect immediately.',
    },
    ...
    windowQuotaOverview: {
      ...
      window5h: '5h',
      window7d: '7d',
      donor: '{window} donated {pct}%',
      donorTip: 'Part of the share has been donated to the relief pool (5h / 7d are independent)',
      attributed: 'Attributed',
      baseLimit: 'Base limit',
      effectiveLimit: 'Effective limit',
      remaining: 'Remaining',
      official: 'Official',
      attributedSum: 'Attributed sum',
      unattributed: 'Unattributed',
      configuredSum: 'Configured sum',
      ceiling: 'Safe ceiling',
      overallocated: 'Overallocated',
      overallocatedWarning: 'The configured sum exceeds the safe ceiling. Adjust the limits or safely rebalance the current members.',
      rebalance: 'Safely rebalance current members',
      previewTitle: 'Safe rebalance preview',
      previewMembers: 'This will rewrite the 5h / 7d limits for the current {count} members on this account.',
      previewValue: '{pct}% per member',
      previewHint: 'Each value is the window ceiling divided by the current member count and will replace manually configured member limits.',
      confirmRebalance: 'Confirm rebalance',
      rebalanceConfirm: 'Safely rebalance the current members of account #{id}? Existing 5h / 7d member limits will be overwritten.',
      rebalanceSuccess: 'Safe rebalance completed and overview refreshed',
      rebalanceFailed: 'Safe rebalance failed',
      manageMembers: 'Choose members',
      memberEditorTitle: 'Choose members and custom limits',
      memberEditorHint: 'Select the shared members for this account and set each member’s independent 5h / 7d base limit. Unselected users are removed from the account.',
      memberSearch: 'Search username, email, or user ID',
      memberColumn: 'Member',
      member5hLimit: '5h limit',
      member7dLimit: '7d limit',
      memberAllocation: '{window} allocated {total}% / safe ceiling {ceiling}%',
      memberLimitHint: 'Limits are percentages of the official window. A value of 0 disables that member for the corresponding window; windows are calculated independently.',
      invalidMemberLimit: 'The {window} limit for user #{user} must be a number between 0 and 100',
      memberCeilingExceeded: '{window} allocation is {total}%, exceeding the safe ceiling of {ceiling}%',
      saveMembers: 'Save members and limits',
      savingMembers: 'Saving...',
      membersConfirm: 'Update account #{id} to the selected {count} members and save limits (5h total {total5h}%, 7d total {total7d}%)?',
      membersSaved: 'Shared members and custom limits saved',
      membersSaveFailed: 'Failed to save shared members',
      memberLimitsSaveFailed: 'Members were synchronized, but not all custom limits were saved. The current server state has been reloaded.',
      loadMembersFailed: 'Failed to load users',
    },
